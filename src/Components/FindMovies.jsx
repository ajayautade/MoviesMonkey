...
class FindMovies extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            genres: [],
            selectedGenre: "",
            baseUrl: `${API_CONFIG.TMDB_BASE_URL}/search/movie?api_key=${API_CONFIG.TMDB_API_KEY}&query=`,
            discoverUrl: `${API_CONFIG.TMDB_BASE_URL}/discover/movie?api_key=${API_CONFIG.TMDB_API_KEY}&include_adult=false&sort_by=popularity.desc&with_genres=`
        }
    ...
    componentDidMount() {
        // Fetch genre list
        axios.get(`${API_CONFIG.TMDB_BASE_URL}/genre/movie/list?api_key=${API_CONFIG.TMDB_API_KEY}&language=en-US`)
            .then(res => {
