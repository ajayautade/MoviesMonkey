...
class MovieDetail extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            movieInfo: {},
            imdbID: "",
            Tmdbendpoint: `${API_CONFIG.TMDB_BASE_URL}/movie/`,
            TmdbApiKey: `/external_ids?api_key=${API_CONFIG.TMDB_API_KEY}&language=en-US`,
            OmdbendPoint: "https://www.omdbapi.com/?i=",
            OmdbApiKey: `&apikey=${API_CONFIG.OMDB_API_KEY}`
        }
    }
